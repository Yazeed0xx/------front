        ...
        <Card className="border border-border/60 rounded-2xl">
          <CardContent className="py-8 items-center">
            <View className="w-20 h-20 rounded-full bg-red-500/10 items-center justify-center mb-6">
              <Icon as={XCircle} size={40} className="text-red-600" />
            </View>
            ...
            <Text className="text-muted-foreground text-center mb-6 px-4">
              {t('registrationRejectedDescription')}
            </Text>

            {company?.rejectionReason && (
              <View className="bg-red-500/10 rounded-xl px-4 py-3 w-full mb-6">
                <Text className="text-xs text-muted-foreground uppercase tracking-wide mb-1">
                  {t('rejectionReason')}
                </Text>
                <Text className="text-red-700 text-sm">{company.rejectionReason}</Text>
              </View>
            )}
